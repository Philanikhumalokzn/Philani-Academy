      ...
      <>
        <OverlayPortal>
          <FullScreenGlassOverlay
            ...
            position="fixed"
            forceHeaderSafeTop
            headerSafeTopClassName="pt-[var(--app-safe-top)] sm:pt-[var(--app-safe-top)]"
            headerStyle={{ paddingTop: 'max(calc(var(--app-safe-top, 0px) - 1rem), 0px)' }}
          ...
          >
            <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-white p-0 text-[#1c1e21]">
              ...
              <ComposerActionBar
                tone="bare"
                onOpenTyped={props.onOpenTyped}
                onOpenHandwritten={props.onOpenHandwritten}
                onOpenImage={props.onOpenImagePicker}
  ...
  return (
    <>
      {usesUniversalComposer ? renderUniversalComposer() : (
        <>
          <OverlayPortal>
            <FullScreenGlassOverlay title="Post" onClose={onClose} onBackdropClick={onClose} zIndexClassName="z-[70]" variant="light" panelSize="full" position="fixed" forceHeaderSafeTop headerSafeTopClassName="pt-[var(--app-safe-top)] sm:pt-[var(--app-safe-top)]" headerStyle={{ paddingTop: 'max(calc(var(--app-safe-top, 0px) - 1rem), 0px)' }} respectBottomSafeArea={false} frameClassName="absolute inset-0 flex items-stretch justify-center p-0" panelClassName="!h-full !max-h-none !max-w-none !rounded-none border-none bg-white" className="[&>.philani-overlay-backdrop]:!bg-white [&>.philani-overlay-backdrop]:!backdrop-blur-none" contentClassName="flex flex-col overflow-hidden p-0">
              <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-white p-0 text-[#1c1e21]">
                ...
                <ComposerActionBar
                  tone="outlined"
                  showTypedAction={false}
                  showHandwrittenAction={false}
                  onOpenImage={() => props.uploadInputRef?.current?.click()}
                  imageActionIcon="upload"
                  ...
                  posting={posting}
                  extraLeadingActions={
                    <button type="button" className="philani-gradient-outline [--philani-outline-fill:#ffffff] inline-flex h-11 w-11 items-center justify-center rounded-full text-slate-700 disabled:opacity-50" onClick={props.onClearImage} disabled={!props.imageUrl || uploading} aria-label="Clear screenshot" title="Clear screenshot">
