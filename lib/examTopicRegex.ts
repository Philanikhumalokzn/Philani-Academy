...
const TOPIC_RULES: Record<TopicLabel, TopicRule[]> = {
  ...
  'Space and Shape (Geometry)': [
    ...
    { term: 'space and shape', weight: 2.0 },
    ...
    { term: 'congruence', weight: 1.7 },
    { term: 'similarity', weight: 1.7 },
    { term: 'transformation', weight: 1.7 },
    { term: 'rotation', weight: 1.6 },
    { term: 'translation', weight: 1.6 },
    { term: 'reflection', weight: 1.6 },
  ],
  Measurement: [
  ...
  'Data Handling': [
    ...
    { term: 'mode', weight: 1.8 },
    { term: 'range', weight: 1.5 },
    { term: 'probability', weight: 1.9 },
    { term: 'chance', weight: 1.8 },
