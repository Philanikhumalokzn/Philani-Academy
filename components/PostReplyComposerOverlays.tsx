...
type PostReplyComposerSurfaceProps = {
  blocks: PostReplyBlock[]
  draftText: string
  editingTarget: ComposerBlockEditTarget | null
  viewerName: string
        ...
        <OverlayPortal>
          ...
          >
            <PostReplyComposerSurface
              ...
              onOpenTyped={onOpenTyped}
              onOpenHandwritten={onOpenHandwritten}
              onOpenImagePicker={onOpenImagePicker}
              onSubmitText={onSubmitText}
              onEditBlock={onEditBlock}
              onDeleteBlock={onDeleteBlock}
              onCanvasViewportChange={onCanvasViewportChange}
              onBeginBlockLongPress={onBeginBlockLongPress}
              onMoveBlockLongPress={onMoveBlockLongPress}
              onClearBlockLongPress={onClearBlockLongPress}
              onOpenBlockCrudOptions={onOpenBlockCrudOptions}
            />
