...
const TOPIC_ALIAS_MAP: Record<string, string> = {
  ...
  'patterns functions algebra': 'Patterns and Functions',
  ...
  'symmetry and transformation': 'Transformation Geometry',
  ...
  'geometric constructions': '2D Geometry',
...
const TOPIC_ANCHOR_WORDS: Record<string, string> = {
  ...
  'inverse': 'Functions',
  'pattern': 'Patterns and Functions', 'patterns': 'Patterns and Functions',
  ...
  'space': '2D Geometry', 'shape': '2D Geometry',
  'transformation': 'Transformation Geometry', 'reflection': 'Transformation Geometry',
  'rotation': 'Transformation Geometry', 'translation': 'Transformation Geometry',
  'congruence': '2D Geometry', 'similarity': '2D Geometry',
  'prism': '3D Geometry', 'pyramid': '3D Geometry', 'cylinder': '3D Geometry', 'sphere': '3D Geometry',
