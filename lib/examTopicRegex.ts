...
const TOPIC_RULES: Record<TopicLabel, TopicRule[]> = {
  ...
  'Patterns and Functions': [
    { term: 'pattern', weight: 1.9 },
    { term: 'patterns', weight: 1.9 },
    { term: 'rule', weight: 1.5 },
    { term: 'function', weight: 1.8 },
    { term: 'graph', weight: 1.7 },
    { term: 'equation', weight: 1.6 },
    { term: 'algebra', weight: 1.8 },
    { term: 'expression', weight: 1.6 },
    { term: 'substitute', weight: 1.5 },
    { term: 'simplify', weight: 1.5 },
    { term: 'expand', weight: 1.5 },
    { term: 'factorise', weight: 1.6 },
    { term: 'factorize', weight: 1.6 },
    { term: 'sequence', weight: 1.5 },
  ],
  'Transformation Geometry': [
    { term: 'transformation', weight: 2.0 },
    { term: 'transform', weight: 1.8 },
    { term: 'reflection', weight: 1.9 },
    { term: 'rotation', weight: 1.9 },
    { term: 'translation', weight: 1.9 },
    { term: 'enlargement', weight: 1.8 },
    { term: 'symmetry', weight: 1.7 },
    { term: 'congruence', weight: 1.6 },
    { term: 'similarity', weight: 1.6 },
  ],
  '2D Geometry': [
    { term: 'geometry', weight: 1.9 },
    { term: 'geometric', weight: 1.9 },
    { term: '2d', weight: 1.9 },
    { term: 'two dimensional', weight: 1.9 },
    { term: 'space and shape', weight: 1.9 },
    { term: 'shape', weight: 1.5 },
    { term: 'angle', weight: 1.4 },
    { term: 'triangle', weight: 1.6 },
    { term: 'quadrilateral', weight: 1.7 },
    { term: 'polygon', weight: 1.6 },
    { term: 'circle', weight: 1.6 },
    { term: 'interior angle', weight: 1.8 },
    { term: 'exterior angle', weight: 1.8 },
    { term: 'congruence', weight: 1.5 },
    { term: 'similarity', weight: 1.5 },
  ],
  '3D Geometry': [
    { term: '3d', weight: 1.9 },
    { term: 'three dimensional', weight: 1.9 },
    { term: 'solid', weight: 1.7 },
    { term: 'solid geometry', weight: 1.9 },
    { term: 'prism', weight: 1.9 },
    { term: 'pyramid', weight: 1.9 },
    { term: 'cylinder', weight: 1.9 },
    { term: 'cone', weight: 1.9 },
    { term: 'sphere', weight: 1.9 },
    { term: 'net', weight: 1.7 },
    { term: 'surface area', weight: 1.8 },
    { term: 'volume', weight: 1.7 },
  ],
  Measurement: [
  ...
  'Data Handling': [
    { term: 'data', weight: 1.9 },
    { term: 'data handling', weight: 2.0 },
    { term: 'table', weight: 1.5 },
    { term: 'chart', weight: 1.6 },
    { term: 'graph', weight: 1.4 },
    { term: 'histogram', weight: 1.8 },
    { term: 'bar graph', weight: 1.8 },
    { term: 'line graph', weight: 1.8 },
    { term: 'pie chart', weight: 1.8 },
    { term: 'mean', weight: 1.6 },
    { term: 'median', weight: 1.6 },
    { term: 'mode', weight: 1.6 },
    { term: 'range', weight: 1.4 },
    { term: 'probability', weight: 1.5 },
    { term: 'chance', weight: 1.5 },
    { term: 'sample space', weight: 1.8 },
    { term: 'outcome', weight: 1.7 },
  ],
  Finance: [
