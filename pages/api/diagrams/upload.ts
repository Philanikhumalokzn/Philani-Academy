...
const sanitizeSessionKey = (value: string) => value.replace(/[^a-zA-Z0-9:_-]/g, '-').slice(0, 120)
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const rawSessionKey = Array.isArray(fields.sessionKey) ? fields.sessionKey[0] : fields.sessionKey
